    ...
    return {
        show:function(idOsrc,iWidth,iHeight,scrolling){
            ...
            if((/([a-z0-9-]+\.)+[a-z0-9]{2,4}.*$/.test(idOsrc))){
                var inserStr = "<div style='float:left;margin-left:5px;font-size:14px;'>Resources Download - pin5i.com</div><div style='float:right;margin-right:0px;font-size:14px;'><a href='javascript:void(0);' onclick='showDialog.hide(\"downpop\");'><img src='/custom/down/close.png' /></a></div><div id='downpop'><iframe width = '"+iWidth+"' height = '"+iHeight+"' scrolling = '"+scrolling+"' frameborder = '0' src='"+idOsrc+"'></iframe></div>";
