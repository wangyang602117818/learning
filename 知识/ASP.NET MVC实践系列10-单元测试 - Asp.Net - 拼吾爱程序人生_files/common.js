...
function showMenu1(ctrlid, click, offset, duration, timeout, layer, showid, maxh, drag) {
...
//template_report.js_end

//template_utils.js_start
...
function pin5i_showloginwin(){
  browserinfo();
  if(navigator.Actual_Name=="Microsoft Internet Explorer"){
    window.location.href="login.aspx";
  }
  else{
    floatwin('open_login', 'login.aspx', 600, 410);
    return false;
  }
}


function pin5i_showregistewin(){
  browserinfo();
  if(navigator.Actual_Name=="Microsoft Internet Explorer"){
    window.location.href="register.aspx";
  }
  else{
    floatwin('open_register', 'register.aspx', 600, 410);
    return false;
  }
}

//让背景渐渐变暗
var isIe_pin5i=(document.all)?true:false;
var endInt=70;
function showBackground()
{
var obj_pin5i=document.getElementById("bg");
if(isIe_pin5i)
{
obj_pin5i.filters.alpha.opacity+=1;
if(obj_pin5i.filters.alpha.opacity<endInt)
{
setTimeout(function(){showBackground()},5);
}
}else{
var al=parseFloat(obj_pin5i.style.opacity);al+=0.01;
obj_pin5i.style.opacity=al;
if(al<(endInt/100))
{setTimeout(function(){showBackground()},5);}
}
}